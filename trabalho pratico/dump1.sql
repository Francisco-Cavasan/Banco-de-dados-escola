...
-- Started on 2020-12-08 07:28:08
...
--
-- TOC entry 222 (class 1255 OID 49800)
-- Name: atualiza_aluno(date, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.atualiza_aluno(dtinicial date, dtfinal date) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
cursordtmatri CURSOR FOR SELECT m.dt_matricula, aluno.codaluno
FROM matricula m, aluno
WHERE m.dt_matricula between dtinicial and dtfinal
and m.codaluno=aluno.codaluno;
datatemp date;
codaluno_f int;
begin 
open cursordtmatri;
fetch cursordtmatri into datatemp, codaluno_f;
while found loop
update turma_aluno set dt_matricula = datatemp
where turma_aluno.codaluno=codaluno_f;
fetch cursordtmatri into datatemp, codaluno_f;
end loop;
close cursordtmatri;
return 0;
...
ALTER FUNCTION public.atualiza_aluno(dtinicial date, dtfinal date) OWNER TO postgres;

--
-- TOC entry 223 (class 1255 OID 49966)
-- Name: f_aluno_dtnascimento(date, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.f_aluno_dtnascimento(dtinicial date, dtfinal date) RETURNS TABLE(codaluno integer, nome character varying, data date)
    LANGUAGE plpgsql
    AS $$
begin
return query select al.codaluno, al.nome, al.dt_nascimento
from aluno al 
where al.dt_nascimento between dtinicial and dtfinal;
end;
$$;


ALTER FUNCTION public.f_aluno_dtnascimento(dtinicial date, dtfinal date) OWNER TO postgres;

--
-- TOC entry 225 (class 1255 OID 50002)
-- Name: f_faltas_alunos(date, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.f_faltas_alunos(dtinicial date, dtfinal date) RETURNS TABLE(datafalta date)
    LANGUAGE plpgsql
    AS $$
begin 
return query select fa.datafalta 
from falta
where fa.datafalta between dtinicial and dtfinal;
end;
$$;


ALTER FUNCTION public.f_faltas_alunos(dtinicial date, dtfinal date) OWNER TO postgres;

--
-- TOC entry 224 (class 1255 OID 49988)
-- Name: f_impede_delete(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.f_impede_delete() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin 
if TG_OP='DELETE' then
Raise exception 'Não é possível deletar o nome do aluno';
end if;
if new.nome='' or new.nome=null then
Raise exception 'Não é possível deixar o nome do aluno em branco';
end if;
return null;
end;
$$;
...
ALTER FUNCTION public.f_impede_delete() OWNER TO postgres;

--
-- TOC entry 226 (class 1255 OID 50013)
-- Name: f_quantidade_faltas(date, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.f_quantidade_faltas(dtinicial date, dtfinal date) RETURNS TABLE(quantidade bigint, codturma integer)
    LANGUAGE plpgsql
    AS $$
begin 
return query select count(fa.codaluno), turma.codturma
from falta fa, turma
where fa.datafalta between dtinicial and dtfinal
and fa.codturma = turma.codturma
group by turma.codturma;
end;
$$;


ALTER FUNCTION public.f_quantidade_faltas(dtinicial date, dtfinal date) OWNER TO postgres;

--
-- TOC entry 218 (class 1255 OID 49802)
-- Name: f_valida_falta(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.f_valida_falta() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare 
codaluno_f int;
begin
select new.codaluno into codaluno_f;
if(select distinct ta.codturma from turma_aluno ta where ta.codturma=new.codturma) != (select distinct ta.codturma from turma_aluno ta where ta.codaluno=codaluno_f)
then raise exception 'Aluno não está nessa turma';
end if;
return null;
end;
$$;
...
ALTER FUNCTION public.f_valida_falta() OWNER TO postgres;

--
-- TOC entry 219 (class 1255 OID 49804)
-- Name: f_valida_nota(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.f_valida_nota() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare 
codaluno_f int;
begin 
select turma_aluno.codaluno into codaluno_f
from turma_aluno
where new.codaluno=turma_aluno.codaluno;
if (select prova.codturma from prova where prova.codprova=new.codprova) != (select ta.codturma from turma_aluno ta where ta.codaluno=codaluno_f)
then Raise exception 'Aluno não pertence a turma na qual a prova foi aplicada.';
end if;
return null;
end;
$$;
...
ALTER FUNCTION public.f_valida_nota() OWNER TO postgres;

--
-- TOC entry 220 (class 1255 OID 49805)
-- Name: f_valida_prova(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.f_valida_prova() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare 
codaluno_f int;
...
ALTER FUNCTION public.f_valida_prova() OWNER TO postgres;

--
-- TOC entry 221 (class 1255 OID 49806)
-- Name: valida_prova(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.valida_prova() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare 
codaluno_f int;
begin 
select into codaluno_f
from turma_aluno
where new.codaluno=turma_aluno.codaluno;
if new.codturma != (select ta.codturma from turma_aluno ta where ta.codaluno=codaluno_f)
 then Raise exception 'Aluno não pertence a turma na qual a prova foi aplicada.';
end if;
return null;
end;
...
ALTER FUNCTION public.valida_prova() OWNER TO postgres;
...
--
-- TOC entry 202 (class 1259 OID 49807)
...
--
-- TOC entry 203 (class 1259 OID 49810)
...
--
-- TOC entry 204 (class 1259 OID 49813)
...
--
-- TOC entry 205 (class 1259 OID 49816)
...
--
-- TOC entry 206 (class 1259 OID 49819)
...
--
-- TOC entry 207 (class 1259 OID 49822)
...
--
-- TOC entry 208 (class 1259 OID 49825)
-- Name: nota_aluno; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.nota_aluno (
    codaluno integer NOT NULL,
    nota numeric(11,3),
...
ALTER TABLE public.nota_aluno OWNER TO postgres;

--
-- TOC entry 209 (class 1259 OID 49828)
...
--
-- TOC entry 211 (class 1259 OID 49834)
...
--
-- TOC entry 212 (class 1259 OID 49837)
...
--
-- TOC entry 213 (class 1259 OID 49840)
...
--
-- TOC entry 214 (class 1259 OID 49843)
-- Name: turma_prof_disc; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.turma_prof_disc (
    codprofessor integer NOT NULL,
    codturma integer NOT NULL,
    coddisciplina integer NOT NULL
);
...
ALTER TABLE public.turma_prof_disc OWNER TO postgres;

--
-- TOC entry 215 (class 1259 OID 49983)
-- Name: v_alunos; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_alunos AS
SELECT
...
ALTER TABLE public.v_alunos OWNER TO postgres;

--
-- TOC entry 216 (class 1259 OID 49998)
-- Name: v_alunos_notas; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_alunos_notas AS
 SELECT al.codaluno,
    al.nome,
    al.sexo,
    na.nota
   FROM (public.aluno al
     JOIN public.nota_aluno na ON ((al.codaluno = na.codaluno)))
  ORDER BY al.codaluno;


ALTER TABLE public.v_alunos_notas OWNER TO postgres;

--
-- TOC entry 217 (class 1259 OID 50009)
-- Name: v_alunos_provas; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_alunos_provas AS
 SELECT tr.codturma,
    pr.codprova,
    pr.dataavalicao
   FROM (public.turma tr
     JOIN public.prova pr ON ((tr.codturma = pr.codturma)))
  ORDER BY tr.codturma;


ALTER TABLE public.v_alunos_provas OWNER TO postgres;
...
-- Completed on 2020-12-08 07:28:09
